...
public class HistorialServiceImpl implements HistorialService{
	...
	//implementacion  para filtrar vias por medio del codigo del agente de transito
	@Override
	@Transactional
	...
	////implementacion  para filtrar agente de transito por de (calle o carrera) y el numero de la via 
